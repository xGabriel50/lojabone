...
<head>
    ...
    <title>ChookBonés</title>
</head>

<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="index.php">ChookBonés</a>
                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <li><a class="dropdown-item" href="../view/visuBoneNome.php">Pesquisar por Nome</a></li>
                            <li><a class="dropdown-item" href="../view/visuBoneMarca.php">Pesquisar por Marca</a></li>
                            <li><a class="dropdown-item" href="../view/visuBoneCodigo.php">Pesquisar por Código</a></li>
                        </ul>
                    </li>
                </ul>
                <form class="d-flex">
